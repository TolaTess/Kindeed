...
public class CategoryCustomAdapter extends RecyclerView.Adapter<CategoryCustomAdapter.MyView> {
    ...
    public CategoryCustomAdapter(String category, IntentPresenter intentPresenter, Context context) {
    ...
    public void setmProduct(List<Product> products) {
        List<Product> mFinalProductList = new ArrayList<>();
        for (Product product : products) {
            if (product.getCategory().equalsIgnoreCase(category)) {
                mFinalProductList.add(product);
                mProduct = mFinalProductList;
